                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            ...
                                            <br>
                                            <a href="{{route('store_admin.banneredit',$ban->id)}}" class="btn btn-sm btn-primary">Edit</a>
                                            <a onclick="if(confirm('Are you sure you want to delete this item?')){ event.preventDefault();document.getElementById('delete-form-{{$ban->id}}').submit(); }"  class="btn btn-sm btn-danger">Delete</a>
                                            <form method="post" action="{{route('store_admin.delete_slider')}}" id="delete-form-{{$ban->id}}" style="display: none">
                                                @csrf
                                                @method('DELETE')
